...
// <!-- pandas drop -->
PANDAS += '<block type = "pandas_drop_2">';
PANDAS += ' <value name="a">';
PANDAS += '   <block type="variables_get">';
PANDAS += '     <field name="VAR">df</field>';
PANDAS += '   </block>';
...
PANDAS += '   </shadow>';
PANDAS += ' </value>';
PANDAS += ' <value name="data1">';
PANDAS += '   <shadow type="indata">';
PANDAS += '     <field name="indata1"></field>';
PANDAS += '   </shadow>';
PANDAS += ' </value>';
PANDAS += ' <value name="data2">';
PANDAS += '   <shadow type="indata">';
PANDAS += '     <field name="indata1"></field>';
PANDAS += '   </shadow>';
PANDAS += ' </value>';
...
PANDAS += '   </shadow>';
PANDAS += ' </value>';
PANDAS += ' <value name="plus_data1">';
PANDAS += '   <shadow type="indata">';
PANDAS += '     <field name="indata1"></field>';
PANDAS += '   </shadow>';
PANDAS += ' </value>';
PANDAS += ' <value name="plus_data2">';
PANDAS += '   <shadow type="indata">';
PANDAS += '     <field name="indata1"></field>';
PANDAS += '   </shadow>';
PANDAS += ' </value>';
...
PANDAS += ' <value name="Series_or_Dataframe">';
PANDAS += '   <shadow type="indata">';
PANDAS += '     <field name="indata1"></field>';
PANDAS += '   </shadow>';
PANDAS += ' </value>';
