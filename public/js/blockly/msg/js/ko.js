...
Blockly.Msg['PANDAS_DATAFRAME_3'] = "열 레이블(columns)";
Blockly.Msg['PANDAS_DATAFRAME_4'] = "데이터타입(dtypes)";
Blockly.Msg['PANDAS_DATAFRAME_5'] = "넘파이형식으로 반환(values)";
Blockly.Msg['PANDAS_DATAFRAME_6'] = "축 목록(axes)";
Blockly.Msg['PANDAS_DATAFRAME_7'] = "차원(ndim)";
Blockly.Msg['PANDAS_DATAFRAME_8'] = "크기(int반환)(size)";
Blockly.Msg['PANDAS_DATAFRAME_9'] = "크기(튜플반환)(shape)";
Blockly.Msg['PANDAS_DATAFRAME_10'] = "비어있는지 확인(empty)";
Blockly.Msg['PANDAS_DATAFRAME_11'] = "메모리 사용량 바이트단위 반환(memory_usage)";
