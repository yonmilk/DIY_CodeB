...
Blockly.Msg['PANDAS_ROW_COUNT_1'] = "[프레임속성]";
Blockly.Msg['PANDAS_ROW_COUNT_2'] = "인덱스(index)";
Blockly.Msg['PANDAS_ROW_COUNT_3'] = "열 레이블(columns)";
Blockly.Msg['PANDAS_ROW_COUNT_4'] = "데이터타입(dtypes)";
Blockly.Msg['PANDAS_ROW_COUNT_5'] = "넘파이형식으로 반환(values)";
Blockly.Msg['PANDAS_ROW_COUNT_6'] = "축 목록(axes)";
Blockly.Msg['PANDAS_ROW_COUNT_7'] = "차원(ndim)";
Blockly.Msg['PANDAS_ROW_COUNT_8'] = "크기(int반환)(size)";
Blockly.Msg['PANDAS_ROW_COUNT_9'] = "크기(튜플반환)(shape)";
Blockly.Msg['PANDAS_ROW_COUNT_10'] = "비어있는지 확인(empty)";
Blockly.Msg['PANDAS_ROW_COUNT_11'] = "메모리 사용량 바이트단위 반환(memory_usage)";
