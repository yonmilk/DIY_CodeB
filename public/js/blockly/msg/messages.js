...
/** @type {string} */
Blockly.Msg.LOGIC_ISINSTANCE_HELPURL = 'https://en.wikipedia.org/wiki/%3F:';
/** @type {string} */
Blockly.Msg.LOGIC_ISINSTANCE_TOOLTIP ='Check your brother. Certain information returns a "True" value. Returns the value "False"';
/** @type {string} */
Blockly.Msg.BKY_LOGIC_ISINSTANCE = 'isinstance';
/** @type {string} */
Blockly.Msg.BKY_LOGIC_ISINSTANCE_F ='isinstance';
/** @type {string} */
Blockly.Msg.BKY_LOGIC_ISINSTANCE_B ='isinstance';
/** @type {string} */
