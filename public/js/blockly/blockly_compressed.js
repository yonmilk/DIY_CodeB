...
Blockly.DropDownDiv.show = function (a, b, c, d, e, f, g) {
  ...
  Blockly.DropDownDiv.rendererClassName_ = Blockly.getMainWorkspace()
    .getRenderer()
    .getClassName();
  Blockly.DropDownDiv.themeClassName_ = Blockly.getMainWorkspace()
    .getTheme()
    .getClassName();
...
Blockly.DropDownDiv.hideWithoutAnimation = function () {
  if (Blockly.DropDownDiv.isVisible()) {
    ...
    Blockly.DropDownDiv.owner_ = null;
    Blockly.DropDownDiv.rendererClassName_ &&
      (Blockly.utils.dom.removeClass(a, Blockly.DropDownDiv.rendererClassName_),
      (Blockly.DropDownDiv.rendererClassName_ = ""));
    Blockly.DropDownDiv.themeClassName_ &&
...
Blockly.Themes.Classic.defaultBlockStyles = {
  ...
  list_blocks: { colourPrimary: "#1e1e1e", colourTertiary: "#ff8c1a"}, // 배열 몸통
  list_blocks_sub: { colourPrimary: "#ff8c1a", colourTertiary: "#bf6913"}, // 배열 부속

  logic_blocks: { colourPrimary: "#1e1e1e", colourTertiary : "#9966FF"},// 논리 몸통 블록
  logic_blocks_sub: { colourPrimary: "#9966FF", colourTertiary : "#6543ab"}, // 논리 부속 블록

  loop_blocks: { colourPrimary: "#1e1e1e", colourTertiary: "#D65CD6"},// 반복
  loop_blocks_sub: { colourPrimary: "#D65CD6", colourTertiary: "#873787"},// 반복

  math_blocks: { colourPrimary: "#1e1e1e", colourTertiary : "E8754D"},// 연산
  math_blocks_sub: { colourPrimary: "#E8754D", colourTertiary : "ab5638" },// 연산

  procedure_blocks: { colourPrimary: "#41CDCD" }, // ?

  text_blocks: { colourPrimary: "#1e1e1e", colourTertiary: "FFAB19" }, // 문자
  text_blocks_sub: { colourPrimary: "#FFAB19", colourTertiary: "#ad7411"}, // 문자
  text_mutator: { colourPrimary: "#b37814", colourTertiary: "b37814"},

  variable_blocks: { colourPrimary: "#1e1e1e", colourTertiary: "#4C97FF"},// 변수 몸통 블록
  variable_blocks_sub: { colourPrimary: "#4C97FF", colourTertiary: "#3465a8"},// 변수 몸통 블록

  conversion_blocks: { colourPrimary: "#1e1e1e", colourTertiary: "#4CBFE6"},// 컬렉션 몸통
  conversion_blocks_sub: { colourPrimary: "#4CBFE6", colourTertiary: "#378aa6"},// 컬렉션 부속
  ...
  // 데이터베이스
  database_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#467cb1"}, // 몸통
  database_blocks_sub: {colourPrimary: "#467cb1", colourTertiary: "#2d4f70"}, // 부속

  // 함수 & 클래스
  function_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#41CDCD"}, // 함수 몸통
  function_blocks_sub : {colourPrimary: "#41CDCD", colourTertiary: "#288585"}, // 함수 부속

  class_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#5BA561"}, // 클래스 몸통
  class_blocks_sub: {colourPrimary: "#5BA561", colourTertiary: "#315934"}, // 클래스 부속

  // 리스트
  // 리스트는 기존에 존재하지만 새로 만든 커스텀 리스트에 대한 블록 색상 정의
  custom_list_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#40BF4A"}, // 리스트 몸통
  custom_list_blocks_sub: {colourPrimary: "#40BF4A", colourTertiary: "#266e2c"}, // 리스트 부속

  // 집합
  set_type_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#FF6680"}, // 집합 몸통
  set_type_blocks_sub: {colourPrimary: "#FF6680", colourTertiary: "#993c4c"}, // 집합 몸통

  // 딕셔너리
  dict_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#a55b5b"}, // 집합 몸통
  dict_blocks_sub: {colourPrimary: "#a55b5b", colourTertiary: "#613535"}, // 집합 몸통

  // 디큐
  deque_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#6d5ba5"},
  deque_blocks_sub: {colourPrimary: "#6d5ba5", colourTertiary: "#392f57"},

  // OS
  os_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#55ad15"},
  os_blocks_sub: {colourPrimary: "#55ad15", colourTertiary: "#2d5c0b"},
  ...
  // 넘파이
  numpy_blocks: {colourPrimary: "#1e1e1e", colourTertiary: "#472BFF"}, // 몸통
  numpy_blocks_sub: {colourPrimary: "#472BFF", colourTertiary: "#170e57"}, // 부속

  // 판다스
  pandas_blocks : {colourPrimary: "#1e1e1e", colourTertiary: "#FF3D98"}, // 몸통
  pandas_blocks_sub : {colourPrimary: "#FF3D98", colourTertiary: "#7a1b48"}, // 부속

  // Matplotlib
  matplot_blocks : {colourPrimary: "#1e1e1e", colourTertiary: "#E8BE38"}, // 몸통
  matplot_blocks_sub : {colourPrimary: "#E8BE38", colourTertiary: "#614f16"}, // 부속

  //Scipy
  scipy_blocks : {colourPrimary: "#1e1e1e", colourTertiary: "#5AE88A"}, // 몸통
  scipy_blocks_sub : {colourPrimary: "#5AE88A", colourTertiary: "#205733"}, // 부속

  //Scikit-Learn
  sklearn_blocks : {colourPrimary: "#1e1e1e", colourTertiary: "#E85938"}, // 몸통
  sklearn_blocks_sub : {colourPrimary: "#E85938", colourTertiary: "#692718"}, // 몸통

  //Scikit-Image
  skimage_blocks : {colourPrimary: "#1e1e1e", colourTertiary: "#008C8C"},
  skimage_blocks_sub : {colourPrimary: "#008C8C", colourTertiary: "#003b3b"},
...
Blockly.Options.parseThemeOptions_ = function (a) {
  ...
  return a instanceof Blockly.Theme
    ? a
    : Blockly.Theme.defineTheme("builtin", a);
};
...
Blockly.Workspace.prototype.remainingCapacityOfType = function (a) {
  return this.options.maxInstances
    ? (this.options.maxInstances[a] || Infinity) -
        this.getBlocksByType(a, !1).length
    : Infinity;
};
...
Blockly.BubbleDragger.prototype.endBubbleDrag = function (a, b) {
  ...
  this.workspace_.getToolbox() &&
    ((a = this.draggingBubble_.isDeletable()
      ? "blocklyToolboxDelete"
      : "blocklyToolboxGrab"),
    this.workspace_.getToolbox().removeStyle(a));
  Blockly.Events.setGroup(!1);
};
...
Blockly.navigation.resetFlyout_ = function (a) {
  Blockly.navigation.getFlyoutCursor_() &&
    ...
    a && Blockly.getMainWorkspace().getFlyout().hide());
};
...
Blockly.navigation.moveWSCursor_ = function (a, b) {
  ...
  c.setCurNode(
    Blockly.ASTNode.createWorkspaceNode(
      ...
      new Blockly.utils.Coordinate(a, b)
    )
  );
  return !0;
};
...
Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function () {
  return this.targetBlock_ && this.flyout_.isBlockCreatable_(this.targetBlock_)
...
Blockly.Field.prototype.getScaledBBox = function () {
  ...
  return { top: c.y, bottom: c.y + a, left: c.x, right: c.x + d };
};
...
Blockly.Menu.prototype.focus = function () {
  ...
  a &&
    (a.focus({ preventScroll: !0 }), Blockly.utils.dom.addClass(a, "focused"));
};
...
Blockly.Menu.prototype.handleMouseOver_ = function (a) {
  if ((a = this.getMenuItem(a.target)))
    a.isEnabled()
...
Blockly.BlockSvg.prototype.setConnectionTracking = function (a) {
  ...
  if (!this.collapsed_)
    for (b = 0; b < this.inputList.length; b++) {
      var c = this.inputList[b].connection;
      c &&
        (c.setTracking(a), (c = c.targetBlock()) && c.setConnectionTracking(a));
    }
};
...
Blockly.WorkspaceSvg.prototype.setVisible = function (a) {
  ...
  if (this.svgGroup_)
    if (
      ...
      this.toolbox_ &&
        (this.toolbox_.HtmlDiv.style.display = a ? "block" : "none"),
      a)
    ) {
    ...
    if (!isNaN(e) && !isNaN(f)) {
      ...
      do {
        ...
        if (!a) {
          ...
          for (var m; (m = l[c]); c++)
            if (
              m.closest(Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(e, f))
                .connection
            ) {
              a = !0;
              break;
...
Blockly.init_ = function (a) {
  ...
  if (b.languageTree) {
    ...
    c
      ? c.init()
      : d && (d.init(a), d.show(b.languageTree.childNodes), d.scrollToStart());
  }
...
Blockly.Names.prototype.getName = function (a, b) {
  ...
  // c = a.toLowerCase() + "_" + b; // 대,소문자 구별

  c = a + "_" + b;   // console 부분 출력 소문자 -> 있는 그대로 출력
  var d =
...
Blockly.Variables.flyoutCategoryBlocks = function (a) {
  ...
  if (0 < a.length) {
    ...
    if (Blockly.Blocks.many_variables) {
      ...
      k.setAttribute("gap", Blockly.Blocks.math_change ? 20 : 8);
      k.appendChild(Blockly.Variables.generateVariableFieldDom(c));
      k.appendChild(Blockly.Xml.textToDom(
    ...
    // V3 변수 인덱싱..?
    if (Blockly.Blocks.variable_indexing) {
      var d = Blockly.utils.xml.createElement("block");
      d.setAttribute("type", "variable_indexing");                    // 블록의 타입 지정
      d.setAttribute("gap", Blockly.Blocks.variables_get ? 20 : 8);   // 블록끼리의 간격 조절
      d.appendChild(Blockly.Variables.generateVariableFieldDom(c));   
      d.appendChild(Blockly.Xml.textToDom('<value name="index"><shadow type="indata"><field name="indata1"></field></shadow></value>'));
      d.appendChild(Blockly.Xml.textToDom('<value name="var2"><shadow type="indata"><field name="indata1"></field></shadow></value>'));
      b.push(d);
    }
    ...
    if (Blockly.Blocks.va_id) {
      ...
      //   '<value name="DELTA"><shadow type="indata"><field name="indata1">1</field></shadow></value>'
      // )),
      d.appendChild(Blockly.Xml.textToDom('<value name="dic1"><shadow type="indata"><field name="indata1"></field></shadow></value>')),
...
Blockly.WidgetDiv.show = function (a, b, c) {
  ...
  Blockly.WidgetDiv.rendererClassName_ = Blockly.getMainWorkspace()
    .getRenderer()
    .getClassName();
  Blockly.WidgetDiv.themeClassName_ = Blockly.getMainWorkspace()
    .getTheme()
    .getClassName();
...
Blockly.tree.BaseNode.prototype.selectChild = function () {
  return this.hasChildren()
    ? (this.expanded_ ? this.getChildAt(0).select() : this.setExpanded(!0), !0)
    : !1;
};
...
Blockly.tree.TreeControl.prototype.getCalculatedIconClass = function () {
  ...
  return !a && b
    ? b
    : a && this.config_.cssExpandedRootIcon
    ? this.config_.cssTreeIcon + " " + this.config_.cssExpandedRootIcon
    : "";
};
...
Blockly.tree.TreeControl.prototype.detachEvents_ = function () {
  this.onFocusWrapper_ &&
    (Blockly.unbindEvent_(this.onFocusWrapper_), (this.onFocusWrapper_ = null));
  this.onBlurWrapper_ &&
    (Blockly.unbindEvent_(this.onBlurWrapper_), (this.onBlurWrapper_ = null));
  this.onClickWrapper_ &&
    (Blockly.unbindEvent_(this.onClickWrapper_), (this.onClickWrapper_ = null));
  this.onKeydownWrapper_ &&
    (Blockly.unbindEvent_(this.onKeydownWrapper_),
    (this.onKeydownWrapper_ = null));
};
...
Blockly.Toolbox.prototype.addColour_ = function (a) {
  ...
  for (var b = 0, c; (c = a[b]); b++) {
    ...
    if (d) {
      var iconOne = document.createElement("span")
    iconOne.className = "iconOne"
      var e = this.hasColours_
        ? "3px solid " + (c.hexColour || "#ddd")
        : "none";
      this.workspace_.RTL
        ? (iconOne.style.backgroundColor = (c.hexColour || "#ddd"), d.querySelector('.iconOne') == null && d.className == "blocklyTreeRow" ? d.insertBefore(iconOne, d.childNodes[1]): "")
        : (iconOne.style.backgroundColor = (c.hexColour || "#ddd"), d.querySelector('.iconOne') == null && d.className == "blocklyTreeRow" ? d.insertBefore(iconOne, d.childNodes[1]): "");
    }
    this.addColour_(c);
  }
...
Blockly.FieldVariable.prototype.setTypes_ = function (a, b) {
  ...
  if (null == a || void 0 == a) a = null;
    ...
    if (!c)
      throw Error(
        "Invalid default type '" + b + "' in the definition of a FieldVariable"
      );
  } else
    throw Error(
...
Blockly.blockRendering.MarkerSvg.prototype.positionInput_ = function (a) {
  ...
  a =
    Blockly.utils.svgPaths.moveTo(0, 0) + this.constants_.shapeFor(a).pathDown;
...
Blockly.blockRendering.MarkerSvg.prototype.showAtLocation_ = function (a) {
  a.getType() == Blockly.ASTNode.types.BLOCK
    ...
    : a.getType() == Blockly.ASTNode.types.OUTPUT
    ? ((a = a.getLocation().getSourceBlock()), this.showWithBlockPrevOutput_(a))
...
Blockly.blockRendering.Renderer.prototype.getConnectionPreviewMethod = function (
  ...
  return b.type == Blockly.OUTPUT_VALUE || b.type == Blockly.PREVIOUS_STATEMENT
    ? !a.isConnected() || this.orphanCanConnectAtEnd(c, a.targetBlock(), b.type)
    ...
    switch (c) {
      case d.SHAPES.ROUND:
        return (
          ...
          b -
            c *
              (1 - Math.sin(Math.acos((c - this.constants_.SMALL_PADDING) / c)))
        );
      default:
        return 0;
    }
...
Blockly.zelos.MarkerSvg.prototype.showAtLocation_ = function (a) {
  var b = !1;
  a.getType() == Blockly.ASTNode.types.OUTPUT
    ? (this.showWithInput_(a), (b = !0))
    : a.getType() == Blockly.ASTNode.types.BLOCK &&
      (this.showWithBlock_(a), (b = !0));
