...
Blockly.Python['plt_subplot'] = function(block) {
  ...
  Blockly.Python['plt_subplots'] = function(block) {
    ...
    Blockly.Python['skimage_draw'] = function (block) {
      ...
      Blockly.Python['pandas_pickle_read'] = function (block) {
        var value_name1 = Blockly.Python.valueToCode(block, 'd1', Blockly.Python.ORDER_ATOMIC);
        var value_name = Blockly.Python.valueToCode(block, 'va', Blockly.Python.ORDER_ATOMIC);
        // TODO: Assemble JavaScript into code variable.
        var code = `${value_name1} = pd.read_pickle(${value_name})\n`;
        // TODO: Change ORDER_NONE to the correct strength.
        return code ;
      };

      Blockly.Python['pandas_sql_read'] = function(block) {
      ...
      Blockly.Python['pandas_csv_to'] = function (block) {
        var value_name1 = Blockly.Python.valueToCode(block, 'd1', Blockly.Python.ORDER_ATOMIC);
        var value_name = Blockly.Python.valueToCode(block, 'va', Blockly.Python.ORDER_ATOMIC);
        // TODO: Assemble JavaScript into code variable.
        var code = `${value_name1}.to_csv(${value_name})\n`;
        // TODO: Change ORDER_NONE to the correct strength.
        return code ; 
      };

      Blockly.Python['pandas_pickle_to'] = function (block) {
        var value_name1 = Blockly.Python.valueToCode(block, 'd1', Blockly.Python.ORDER_ATOMIC);
        var value_name = Blockly.Python.valueToCode(block, 'va', Blockly.Python.ORDER_ATOMIC);
        // TODO: Assemble JavaScript into code variable.
        var code = `${value_name1}.to_pickle(${value_name})\n`;
        // TODO: Change ORDER_NONE to the correct strength.
        return code ; 
      };

      Blockly.Python['pandas_sql_to'] = function(block) {
        var variable_list = Blockly.Python.valueToCode(block, 'd1', Blockly.Python.ORDER_ATOMIC);
        var variable_list2 = Blockly.Python.valueToCode(block, 'SQL', Blockly.Python.ORDER_ATOMIC);
        var value_name = Blockly.Python.valueToCode(block, 'CON', Blockly.Python.ORDER_ATOMIC);
        // TODO: Assemble Python into code variable.
        var code = `${variable_list}.to_sql(${variable_list2}, ${value_name})\n`;
        // TODO: Change ORDER_NONE to the correct strength.
        return code ;
      };  

      Blockly.Python['pandas_html_to'] = function (block) {
        var value_name1 = Blockly.Python.valueToCode(block, 'd1', Blockly.Python.ORDER_ATOMIC);
        var value_name = Blockly.Python.valueToCode(block, 'va', Blockly.Python.ORDER_ATOMIC);
        // TODO: Assemble JavaScript into code variable.
        var code = `${value_name1}.to_html(${value_name})\n`;
        // TODO: Change ORDER_NONE to the correct strength.
        return code ; 
      };
    ...
    Blockly.Python['matplotlib_histo_graph_plt'] = function(block) {
      ...
      var code = `plt.hist(${xx}${other})\nplt.title("${title}", fontproperties=fontprop)\nplt.xlabel("${xlable}", fontproperties=fontprop)\nplt.ylabel("${ylable}", fontproperties=fontprop)\nplt.show()\n`;
    ...
    Blockly.Python['matplotlib_axes3d_graph_plt'] = function(block) {
      ...
      var code = `from mpl_toolkits.mplot3d import Axes3D\n\nfig = plt.figure()\nax = Axes3D(fig)\nax.plot_surface(${xx},${yy},${zz}${other})\n\nax.set_xlabel('${xlabel}', fontproperties=fontprop)\nax.set_ylabel('${ylabel}', fontproperties=fontprop)\nax.set_zlabel('${zlabel}', fontproperties=fontprop)\nplt.title('${title}', fontproperties=fontprop)\nplt.show()\n`;
