...
Blockly.defineBlocksWithJsonArray([
  ...
  },
  {
    ...
    output: "Boolean",
    style: "conversion_blocks_sub",//"list_blocks",
...
Blockly.Blocks.lists_create_with = {
  init: function () {
    ...
    this.setStyle("conversion_blocks_sub");//"list_blocks");
...
Blockly.Blocks.lists_indexOf = {
  init: function () {
    ...
    this.appendValueInput("VALUE")
      .setCheck("Array")
      .appendField(new Blockly.FieldImage("/img/Array/A6-logo.png", 25, 23, { alt: "*", flipRtl: "FALSE" }))
...
Blockly.Blocks.lists_getIndex = {
  init: function () {
    ...
    this.appendValueInput("VALUE")
      .setCheck("Array")
      .appendField(new Blockly.FieldImage("/img/Array/A7-logo.png", 25, 23, { alt: "*", flipRtl: "FALSE" }))
...
Blockly.Blocks.lists_getSublist = {
  init: function () {
    ...
    this.appendValueInput("LIST")
      .setCheck("Array")
      .appendField(new Blockly.FieldImage("/img/Array/A9-logo.png", 25, 23, { alt: "*", flipRtl: "FALSE" }))
...
Blockly.Blocks.lists_sort = {
  init: function () {
    this.jsonInit({
      ...
      args0: [
        {"type": "field_image","src": "/img/Array/A11-logo.png","width": 25,"height": 23,"alt": "*","flipRtl": false},
        {
          type: "field_dropdown",
          name: "TYPE",
          options: [
...
Blockly.defineBlocksWithJsonArray([
  ...
  {
    type: "logic_isinstance",      // isinstance()
    message0: "%{BKY_LOGIC_ISINSTANCE}",
    args0:[
      {"type": "field_image","src": "/img/Logic/L8-logo.png","width": 25,"height": 23,"alt": "*","flipRtl": false}
    ],
    message1: "%1 %{BKY_LOGIC_ISINSTANCE_F}",
    args1:[
      { type: "input_value", name: "INSTANCE" }
    ],
    message2: "%1 %{BKY_LOGIC_ISINSTANCE_B}",
    args2:[
...
Blockly.defineBlocksWithJsonArray([
  ...
  },
  {
    ...
    args0: [
      ...
      {"type": "field_image","src": "/img/Repeat/R4-logo.png","width": 25,"height": 23,"alt": "*","flipRtl": false},
  ...
  },
  {
    ...
    args0: [
      {"type": "field_image","src": "/img/Repeat/R5-logo.png","width": 25,"height": 23,"alt": "*","flipRtl": false},
      { type: "field_variable", name: "VAR", variable: null },
      { type: "input_value", name: "LIST", check: "Array" },
    ],
    message1: "%{BKY_CONTROLS_REPEAT_INPUT_DO} %1",
  ...
  },
  {
    ...
    message0: "%1 %2",
    args0: [
      {"type": "field_image","src": "/img/Repeat/R6-logo.png","width": 25,"height": 23,"alt": "*","flipRtl": false},
      {
        type: "field_dropdown",
        name: "FLOW",
        options: [
...
Blockly.defineBlocksWithJsonArray([
  ...
  //       name: "OP", 
  //       options: [
  //         // 원래 값 "ADD", "MINUS", "MULTIPLY", "DIVIDE", "REMAINDER", "POWER", "QUOTIENT"
  //         ["+", "ADD"],
  //         ["-", "-"],
  //         ["*", "*"],
  //         ["/", "/"],
  ...
  },
  {
    ...
    message0: "%1 %2 %3",
    args0: [
      {"type": "field_image","src": "/img/Operation/O4-logo.png","width": 25,"height": 22,"alt": "*","flipRtl": false},
      {
        type: "field_dropdown",
        name: "OP",
        options: [
  ...
  },
  {
    ...
    message0: "%1 %2",
    args0: [
      {"type": "field_image","src": "/img/Operation/O5-logo.png","width": 25,"height": 22,"alt": "*","flipRtl": false},
      {
  ...
  },
  {
    ...
    message0: "%1 %2 %3",
    args0: [
      {"type": "field_image","src": "/img/Operation/O7-logo.png","width": 25,"height": 22,"alt": "*","flipRtl": false},
      {
        type: "field_dropdown",
        name: "OP",
        options: [
  ...
  },
  {
    ...
    message0: "%1 %2 %3",
    args0: [
      {"type": "field_image","src": "/img/Operation/O8-logo.png","width": 25,"height": 22,"alt": "*","flipRtl": false},
      {
        type: "field_dropdown",
        name: "OP",
        options: [
...
Blockly.Blocks.text_print = {
  init: function () {
    this.jsonInit({
      ...
      args0: [
        {"type": "field_image","src": "/img/Text/T2-logo.png","width": 25,"height": 23,"alt": "*","flipRtl": false},
        { type: "input_value", name: "TEXT" },
      ],
      previousStatement: null,
      nextStatement: null,
