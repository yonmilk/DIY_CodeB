...
Blockly.JavaScript['gp'] = function (block) {
  ...
  Blockly.JavaScript['plt_setp'] = function(block) {
    ...
    Blockly.JavaScript['skimage_draw'] = function (block) {
      ...
      Blockly.JavaScript['pandas_pickle_read'] = function(block) {
        var code = '\n';
        return code;
      };

      Blockly.JavaScript['pandas_sql_read'] = function(block) {
        var code = '\n';
        return code;
      };

      Blockly.JavaScript['pandas_csv_to'] = function(block) {
        var code = '\n';
        return code;
      };

      Blockly.JavaScript['pandas_pickle_to'] = function(block) {
        var code = '\n';
        return code;
      };

      Blockly.JavaScript['pandas_sql_to'] = function(block) {
        var code = '\n';
        return code;
      };

      Blockly.JavaScript['pandas_html_to'] = function(block) {
        var code = '\n';
        return code;
      };
