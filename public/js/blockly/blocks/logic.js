...
Blockly.defineBlocksWithJsonArray([  // BEGIN JSON EXTRACT
  ...
  {
    "type": "logic_isinstance",
    "message0": "%{BKY_LOGIC_ISINSTANCE} %1",
    "args0": [
      {
        "type": "input_value",
        "name": "INSTANCE"
    ...
    "message1":"%{BKY_LOGIC_ISINSTANCE_F} %1 %{BKY_LOGIC_ISINSTANCE_B}",
    "args1": [
      {
        "type": "input_value",
        "name": "TYPE"
    ...
    "output": null,
    "style": "logic_blocks",
    "tooltip": "%{BKY_LOGIC_ISINSTANCE_TOOLTIP}",
    "helpUrl": "%{BKY_LOGIC_ISINSTANCE_HELPURL}"
  },
