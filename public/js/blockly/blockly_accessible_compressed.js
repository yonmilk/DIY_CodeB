...
goog.define = function (a, b) {
  COMPILED ||
    ...
    void 0 === goog.global.CLOSURE_UNCOMPILED_DEFINES.nodeType &&
    Object.prototype.hasOwnProperty.call(
      goog.global.CLOSURE_UNCOMPILED_DEFINES,
      a
    )
      ? (b = goog.global.CLOSURE_UNCOMPILED_DEFINES[a])
      : goog.global.CLOSURE_DEFINES &&
        void 0 === goog.global.CLOSURE_DEFINES.nodeType &&
        Object.prototype.hasOwnProperty.call(goog.global.CLOSURE_DEFINES, a) &&
        (b = goog.global.CLOSURE_DEFINES[a]));
...
goog.require = function (a) {
  goog.ENABLE_DEBUG_LOADER &&
    goog.debugLoader_ &&
    goog.getLoader_().earlyProcessLoad(a);
  if (!COMPILED) {
    if (goog.isProvided_(a)) {
      ...
      try {
        ...
        c
          ? c.load(a)
          : goog.logToConsole_(
              "Could not load " + a + " because there is no debug loader."
            );
      } finally {
...
goog.DEPENDENCIES_ENABLED &&
          ...
          if (!(a in f.written || a in f.visited)) {
            ...
            if (a in f.requires)
              for (var b in f.requires[a])
                if (!g.isProvided(b))
                  if (b in f.nameToPath) c(f.nameToPath[b]);
      ...
      for (a = 0; a < d.length; a++)
        if ((b = d[a])) {
          ...
          "goog" == h.module || k
            ...
            : this.importScript_(goog.basePath + b);
  ...
  (goog.DebugLoader.prototype.importScript_ = function (a, b) {
    (
      goog.global.CLOSURE_IMPORT_SCRIPT || goog.bind(this.writeScriptTag_, this)
    )(a, b) && (this.dependencies_.written[a] = !0);
  }),
  (goog.DebugLoader.prototype.importProcessedScript_ = function (a, b, c) {
    this.importScript_(
      "",
      'goog.debugLoader_.retrieveAndExec_("' + a + '", ' + b + ", " + c + ");"
    );
  }),
  (goog.DebugLoader.prototype.retrieveAndExec_ = function (a, b, c) {
    if (!COMPILED) {
      ...
      goog.DebugLoader.IS_OLD_IE_ && this.oldIeWaiting_
        ? ((this.dependencies_.deferred[d] = f), this.queuedModules_.push(d))
        : e(a, f);
    }
  }),
  ...
  (goog.DebugLoader.prototype.maybeProcessDeferredDep_ = function (a) {
    this.isDeferredModule_(a) &&
      this.allDepsAreAvailable_(a) &&
  ...
  (goog.DebugLoader.prototype.isDeferredModule_ = function (a) {
    var b =
        ((a = this.getPathFromDeps_(a)) && this.dependencies_.loadFlags[a]) ||
        {},
      c = b.lang || "es3";
    return a && ("goog" == b.module || this.getTranspiler().needsTranspile(c))
      ? goog.basePath + a in this.dependencies_.deferred
      : !1;
  }),
      ...
      void 0 === b
        ? goog.DebugLoader.IS_OLD_IE_
          ? ((this.oldIeWaiting_ = !0),
            (b =
              " onreadystatechange='goog.debugLoader_.onScriptLoad_(this, " +
              ++this.lastNonModuleScriptIndex_ +
              ")' "),
            c.write(
          ...
          : goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING
          ? this.appendScriptSrcNode_(a)
          : this.writeScriptSrcNode_(a)
        : c.write(
            '<script type="text/javascript">' +
              this.protectScriptTag_(b) +
              "\x3c/script>"
          );
      return !0;
    }
  ...
  (goog.DebugLoader.prototype.onScriptLoad_ = function (a, b) {
    "complete" == a.readyState &&
      this.lastNonModuleScriptIndex_ == b &&
      this.loadQueuedModules_();
    return !0;
  }),
  (goog.DebugLoader.prototype.getPathFromDeps_ = function (a) {
    return a in this.dependencies_.nameToPath
      ? this.dependencies_.nameToPath[a]
      : null;
  }),
        ...
        if (goog.isDef(a))
          if (goog.isNull(a)) c.push("NULL");
            ...
            if (e[n]) c.push("*** reference loop detected (id=" + n + ") ***");
              ...
              c.push("{");
              for (var p in a)
                if (b || !goog.isFunction(a[p]))
                  c.push("\n"), c.push(g), c.push(p + " = "), f(a[p], g);
              c.push("\n" + h + "}");
              delete e[n];
            }
          } else c.push(a);
    ...
    b &&
      (goog.isString(b)
        ...
        : ((a = function (a) {
          ...
          goog.isArray(b)
            ? goog.array.forEach(b, a)
            : !goog.isArrayLike(b) || "nodeType" in b
            ? a(b)
            : goog.array.forEach(goog.array.clone(b), a))));
};
...
goog.ui.Control.prototype.setVisible = function (a, b) {
  return b ||
    ...
    ? ((b = this.getElement()) && this.renderer_.setVisible(b, a),
...
goog.ui.Container.prototype.highlightHelper = function (a, b) {
  ...
  for (var d = 0; d <= c; ) {
    ...
    if (e && this.canHighlightItem(e))
      return this.setHighlightedIndexFromKeyEvent(b), !0;
    d++;
    b = a.call(this, b, c);
  }
  return !1;
...
goog.ui.PaletteRenderer.prototype.createCell = function (a, b) {
  ...
  goog.dom.getTextContent(a) ||
    goog.a11y.aria.getLabel(a) ||
    ((b = this.findAriaLabelForCell_(a)) && goog.a11y.aria.setLabel(a, b));
  return a;
};
...
goog.ui.PaletteRenderer.prototype.getContainingItem = function (a, b) {
  for (
    a = a.getElement();
    b && b.nodeType == goog.dom.NodeType.ELEMENT && b != a;
...
goog.ui.tree.BaseNode.prototype.removeChild = function (a, b) {
  ...
  if (c && (c.removeNode(a), this.isInDocument())) {
    ...
    this.hasChildren() ||
      ...
      this.updateIcon_(),
      (b = this.getElement()) &&
        goog.a11y.aria.removeState(b, goog.a11y.aria.State.EXPANDED));
  }
  return a;
};
...
Blockly.VariableMap.prototype.renameVariable = function (a, b) {
  ...
  c && (e = g.indexOf(c));
  -1 == d && -1 == e
    ? (this.createVariable(b, ""),
      console.log("Tried to rename an non-existent variable."))
    : d == e || (-1 != d && -1 == e)
    ? ((a = this.variableMap_[f][d]),
      Blockly.Events.fire(new Blockly.Events.VarRename(a, b)),
      (a.name = b))
    : -1 != d &&
      -1 != e &&
      ((a = this.variableMap_[f][e]),
      Blockly.Events.fire(new Blockly.Events.VarRename(a, b)),
      Blockly.Events.fire(
        new Blockly.Events.VarDelete(this.variableMap_[f][d])
      ),
      (a.name = b),
      this.variableMap_[f].splice(d, 1));
};
  ...
  if (d) {
    if (b && d.type != b)
      throw Error(
        'Variable "' +
          a +
          '" is already in use and its type is "' +
          d.type +
          '" which conflicts with the passed in type, "' +
          b +
          '".'
      );
    if (c && d.getId() != c)
...
Blockly.Workspace.prototype.updateVariableStore = function (a) {
  if (!this.isFlyout) {
    for (
      var b = Blockly.Variables.allUsedVariables(this), c = [], d = 0, e;
      (e = b[d]);
      d++
    ) {
      var f = this.getVariable(e);
      f
        ? c.push({ name: f.name, type: f.type, id: f.getId() })
        : c.push({ name: e, type: null, id: null });
    }
...
Blockly.Workspace.prototype.deleteVariable = function (a) {
  for (var b = this.getVariableUses(a), c = 0, d; (d = b[c]); c++)
    if (
      "procedures_defnoreturn" == d.type ||
      "procedures_defreturn" == d.type
    ) {
...
Blockly.Workspace.prototype.deleteVariableById = function (a) {
  ...
  b
    ? this.deleteVariableInternal_(b)
    ...
    this.setTooltip(
      function () {
        return Blockly.utils
          ...
          .replace("%1", this.getFieldValue(b));
      }.bind(this)
    );
  };
};
...
Blockly.DraggedConnectionManager.prototype.applyConnections = function () {
  this.closestConnection_ &&
    ...
    this.topBlock_.rendered &&
      ((this.localConnection_.isSuperior()
        ? this.closestConnection_
...
Blockly.DraggedConnectionManager.prototype.update = function (a, b) {
  ...
  this.wouldDeleteBlock_ =
    (b = !!b && !this.topBlock_.getParent() && this.topBlock_.isDeletable()) &&
    !c;
  b &&
    this.closestConnection_ &&
...
Blockly.BlockDragger.prototype.endBlockDrag = function (a, b) {
  ...
  this.maybeDeleteBlock_() ||
    (this.draggingBlock_.moveConnections_(a.x, a.y),
...
Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function () {
  ...
  this.wouldDeleteBlock_
    ? (a && goog.Timer.callOnce(a.close, 100, a),
      this.fireMoveEvent_(),
...
Blockly.ConnectionDB.prototype.getNeighbours = function (a, b) {
  ...
  for (var g = d.length - 2, h = g; a < h; )
    d[h].y_ < f ? (a = h) : (g = h), (h = Math.floor((a + g) / 2));
  var k = [];
  g = a = h;
  if (d.length) {
    for (; 0 <= a && c(a); ) a--;
...
Blockly.utils.checkMessageReferences = function (a) {
  for (
    var b = !0,
      c = Blockly.utils.getMessageArray_(),
        ...
        ("" == h
          ...
          : ((e = a.join("")),
            /[a-zA-Z][a-zA-Z0-9_]*/.test(e)
              ? ((h = e.toUpperCase()),
                (h = goog.string.startsWith(h, "BKY_")
                  ? h.substring(4)
                  : null) && h in Blockly.utils.getMessageArray_()
                  ? ((e = Blockly.utils.getMessageArray_()[h]),
                    goog.isString(e)
...
Blockly.WorkspaceAudio.prototype.play = function (a, b) {
  ...
  c
    ? ((a = new Date()),
      (null != this.lastSound_ && a - this.lastSound_ < Blockly.SOUND_LIMIT) ||
        ((this.lastSound_ = a),
        (c =
...
Blockly.Xml.blockToDom = function (a, b) {
  ...
  for (var e; (e = a.inputList[d]); d++)
    for (var f = 0, g; (g = e.fieldRow[f]); f++) {
      ...
      h.name &&
        h.EDITABLE &&
        ((g = goog.dom.createDom("field", null, h.getValue())),
        g.setAttribute("name", h.name),
        h instanceof Blockly.FieldVariable &&
          (h = a.workspace.getVariable(h.getValue())) &&
          (g.setAttribute("id", h.getId()),
          g.setAttribute("variabletype", h.type)),
        c.appendChild(g));
    }
...
Blockly.Xml.appendDomToWorkspace = function (a, b) {
  ...
  if (d && d.height) {
    ...
    b.RTL && (k = b.getWidth());
    for (d = 0; d < a.length; d++)
      b.getBlockById(a[d]).moveBy(b.RTL ? k - e : e, c);
  }
  return a;
};
  ...
  for (var f = null, g = 0, h; (h = a.childNodes[g]); g++)
    if (3 != h.nodeType) {
      ...
      for (var p; (p = h.childNodes[f]); f++)
        1 == p.nodeType &&
          ("block" == p.nodeName.toLowerCase()
            ? (k = p)
            : "shadow" == p.nodeName.toLowerCase() && (n = p));
      !k && n && (k = n);
      ...
      switch (h.nodeName.toLowerCase()) {
        ...
        case "statement":
          ...
          k &&
            ((f = Blockly.Xml.domToBlockHeadless_(k, b)),
            f.outputConnection
...
Blockly.WorkspaceSvg.prototype.getGesture = function (a) {
  ...
  return c
    ? b && c.hasStarted()
      ...
      : c
    : b
    ? (this.currentGesture_ = new Blockly.Gesture(a, this))
    : null;
};
...
Blockly.Block.prototype.setColour = function (a) {
  ...
  else if (goog.isString(a) && /^#[0-9a-fA-F]{6}$/.test(a))
...
Blockly.Block.prototype.jsonInit = function (a) {
  ...
  void 0 !== a.tooltip &&
    ((b = a.tooltip),
    (b = Blockly.utils.replaceMessageReferences(b)),
    this.setTooltip(b));
  void 0 !== a.enableContextMenu &&
    ((b = a.enableContextMenu), (this.contextMenu = !!b));
  void 0 !== a.helpUrl &&
    ((b = a.helpUrl),
    (b = Blockly.utils.replaceMessageReferences(b)),
    this.setHelpUrl(b));
...
Blockly.BlockSvg.disposeUiStep_ = function (a, b, c, d) {
  ...
  1 < e
    ...
    : (a.setAttribute(
      ...
      setTimeout(Blockly.BlockSvg.disposeUiStep_, 10, a, b, c, d));
};
  ...
  1 < d
    ...
    : (a.setAttribute("r", 25 * d * c),
      ...
      (Blockly.BlockSvg.disconnectUiStop_.pid_ = setTimeout(
        Blockly.BlockSvg.connectionUiStep_,
        10,
        a,
        b,
        c
...
Blockly.BlockSvg.disconnectUiStep_ = function (a, b, c) {
  ...
  1 < d
    ...
    : ((a.skew_ =
      ...
      (Blockly.BlockSvg.disconnectUiStop_.pid = setTimeout(
        Blockly.BlockSvg.disconnectUiStep_,
        10,
        a,
        b,
        c
    ...
    if (m.isVisible()) {
      if (
        ...
        (k = m.type),
          (l = []),
          (l.type =
            n && m.type != Blockly.NEXT_STATEMENT
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function (a, b, c, d, e, f) {
  for (var g, h = 0, k, n, p = 0, m; (m = e[p]); p++) {
    ...
    if (this.isCollapsed()) {
      ...
      a.push("v", l);
      this.RTL &&
        (b.push("v 3.9 l 7.2,3.4 m -14.5,8.9 l 7.3,3.5"), b.push("v", l - 0.7));
      ...
      for (var q = 0; (l = m[q]); q++)
        (k = h),
          ...
          (g = this.renderFields_(l.fieldRow, g, k)),
          l.type != Blockly.DUMMY_INPUT &&
            (g += l.renderWidth + Blockly.BlockSvg.SEP_SPACE_X),
          l.type == Blockly.INPUT_VALUE &&
            (c.push(
              "M",
              g -
            ...
            c.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth),
            c.push(Blockly.BlockSvg.TAB_PATH_DOWN),
            c.push("v", l.renderHeight + 1 - Blockly.BlockSvg.TAB_HEIGHT),
            c.push("h", l.renderWidth + 2 - Blockly.BlockSvg.TAB_WIDTH),
            c.push("z"),
            this.RTL
              ? (d.push(
                  "M",
                ...
                d.push("v", l.renderHeight - Blockly.BlockSvg.TAB_HEIGHT + 2.5),
                d.push("h", l.renderWidth - Blockly.BlockSvg.TAB_WIDTH + 2))
              : (d.push(
                  "M",
                  g -
                    Blockly.BlockSvg.SEP_SPACE_X +
                ...
                d.push("v", l.renderHeight + 1),
                d.push("h", Blockly.BlockSvg.TAB_WIDTH - 2 - l.renderWidth),
                d.push(
                  "M",
                  g -
                    l.renderWidth -
      ...
      m.type == Blockly.INPUT_VALUE
        ? ((l = m[0]),
          (k = h),
          l.align != Blockly.ALIGN_LEFT &&
            ((q =
              e.rightEdge -
              l.fieldWidth -
              Blockly.BlockSvg.TAB_WIDTH -
              2 * Blockly.BlockSvg.SEP_SPACE_X),
            l.align == Blockly.ALIGN_RIGHT
              ? (g += q)
              : l.align == Blockly.ALIGN_CENTRE && (g += q / 2)),
          this.renderFields_(l.fieldRow, g, k),
          a.push(Blockly.BlockSvg.TAB_PATH_DOWN),
          (q = m.height - Blockly.BlockSvg.TAB_HEIGHT),
          a.push("v", q),
          this.RTL
          ...
          l.connection.setOffsetInBlock(k, h),
          l.connection.isConnected() &&
            (this.width = Math.max(
              this.width,
              e.rightEdge +
                l.connection.targetBlock().getHeightWidth().width -
                Blockly.BlockSvg.TAB_WIDTH +
                1
            )))
        ...
        ? ((l = m[0]),
          ...
          l.align != Blockly.ALIGN_LEFT &&
            ((q =
              e.rightEdge - l.fieldWidth - 2 * Blockly.BlockSvg.SEP_SPACE_X),
        ...
        : m.type == Blockly.NEXT_STATEMENT &&
          ...
          a.push("v", m.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
          ...
          this.RTL
            ? (b.push(
              ...
              b.push("v", m.height - 2 * Blockly.BlockSvg.CORNER_RADIUS),
  ...
  for (var c = [], d = Object.create(null), e = 0, f; (f = a[e]); e++)
    if (!f.isNull()) {
      var g = [f.type, f.blockId, f.workspaceId].join(" "),
        h = d[g];
      h
        ? f.type == Blockly.Events.MOVE
          ? ((h.newParentId = f.newParentId),
            (h.newInputName = f.newInputName),
            (h.newCoordinate = f.newCoordinate))
          : f.type == Blockly.Events.CHANGE &&
            f.element == h.element &&
            f.name == h.name
          ? (h.newValue = f.newValue)
          : f.type != Blockly.Events.UI ||
            "click" != f.element ||
            ("commentOpen" != h.element &&
              "mutatorOpen" != h.element &&
              "warningOpen" != h.element)
          ? ((d[g] = f), c.push(f))
          : (h.newValue = f.newValue)
        : ((d[g] = f), c.push(f));
    }
...
Blockly.Events.Abstract = function (a) {
  ...
  a instanceof Blockly.Block
    ? ((this.blockId = a.id), (this.workspaceId = a.workspace.id))
    : a instanceof Blockly.VariableModel &&
      ((this.workspaceId = a.workspace.id), (this.varId = a.getId()));
...
Blockly.Variables.allVariables = function (a) {
  return a instanceof Blockly.Block
    ? (console.warn(
  ...
  if (0 < a.length) {
    ...
    if (Blockly.Blocks.variables_set) {
      ...
      d =
        ...
        d +
        '">' +
        Blockly.Variables.generateVariableFieldXml_(c) +
        "</block></xml>";
    ...
    for (c = 0; (d = a[c]); c++)
      Blockly.Blocks.variables_get &&
        ((d =
          ...
          Blockly.Variables.generateVariableFieldXml_(d) +
          "</block></xml>"),
        (d = Blockly.Xml.textToDom(d).firstChild),
        b.push(d));
  }
...
Blockly.Variables.renameVariable = function (a, b, c) {
  var d = function (e) {
    Blockly.Variables.promptName(
      Blockly.Msg.RENAME_VARIABLE_TITLE.replace("%1", b.name),
      e,
      function (e) {
        if (e) {
...
Blockly.FieldVariable.dropdownCreate = function () {
  ...
  Blockly.Msg.DELETE_VARIABLE &&
    c.push([
      Blockly.Msg.DELETE_VARIABLE.replace("%1", b),
...
Blockly.Flyout.prototype.init = function (a) {
  ...
  this.workspace_.getVariable = this.targetWorkspace_.getVariable.bind(
    this.targetWorkspace_
  );
  this.workspace_.getVariableById = this.targetWorkspace_.getVariableById.bind(
    this.targetWorkspace_
  );
  this.workspace_.getVariablesOfType = this.targetWorkspace_.getVariablesOfType.bind(
    this.targetWorkspace_
  );
  this.workspace_.deleteVariable = this.targetWorkspace_.deleteVariable.bind(
    this.targetWorkspace_
  );
  this.workspace_.deleteVariableById = this.targetWorkspace_.deleteVariableById.bind(
    this.targetWorkspace_
  );
  this.workspace_.renameVariable = this.targetWorkspace_.renameVariable.bind(
    this.targetWorkspace_
  );
  this.workspace_.renameVariableById = this.targetWorkspace_.renameVariableById.bind(
    this.targetWorkspace_
  );
};
...
Blockly.VerticalFlyout.prototype.getClientRect = function () {
  ...
  return this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT
    ? new goog.math.Rect(b - 1e9, -1e9, 1e9 + a, 2e9)
    : new goog.math.Rect(b, -1e9, 1e9 + a, 2e9);
};
      ...
      switch (g.tagName.toUpperCase()) {
        case "CATEGORY":
          ...
          goog.isString(h)
            ? (/^#[0-9a-fA-F]{6}$/.test(h)
                ? (e.hexColour = h)
                : (e.hexColour = Blockly.hueToRgb(Number(h))),
              (this.hasColours_ = !0))
            : (e.hexColour = "");
...
blocklyApp.AudioService = ng.core.Class({
  constructor: [
    ...
    function (a) {
      ...
      this.canPlayAudio = !1;
      ACCESSIBLE_GLOBALS.hasOwnProperty("mediaPathPrefix") &&
        ((this.canPlayAudio = !0),
        (a = ACCESSIBLE_GLOBALS.mediaPathPrefix),
        (this.AUDIO_PATHS_ = {
          connect: a + "click.mp3",
          delete: a + "delete.mp3",
          oops: a + "oops.mp3",
  ...
  play_: function (a, b) {
    if (this.canPlayAudio) {
      ...
      if (b)
        this.onEndedCallbacks_[a].push(b),
          this.cachedAudioFiles_[a].addEventListener("ended", b);
      else {
        var c = this;
...
blocklyApp.BlockConnectionService = ng.core.Class({
  ...
  findCompatibleConnection_: function (a, b) {
    ...
    return (a =
      c == Blockly.OUTPUT_VALUE
        ? a.outputConnection
        : c == Blockly.PREVIOUS_STATEMENT
        ? a.previousConnection
        : c == Blockly.NEXT_STATEMENT
        ? a.nextConnection
        : null) && a.checkType_(b)
      ? a
      : null;
  ...
  attachToMarkedConnection: function (a) {
    ...
    var b =
      this.markedConnection_.targetBlock() &&
      this.markedConnection_.type == Blockly.PREVIOUS_STATEMENT
        ? this.markedConnection_.targetConnection
    ...
    throw Error(
      "Unable to connect block to marked connection. This should not happen."
    );
  },
});
  ...
  constructor: [
    function () {
      ...
      this.preShowHook = function () {
        throw Error(
          "A pre-show hook must be defined for the block options modal before it can be shown."
        );
      };
      this.modalIsShown = !1;
...
Blockly.CommonModal.setupKeyboardOverrides = function (a) {
  a.keyboardInputService.setOverride({
    9: function (b) {
      ...
      b.stopPropagation();
      b.shiftKey
        ? 0 >= a.activeButtonIndex
          ? ((a.activeActionButtonIndex = 0), a.audioService.playOopsSound())
          : a.activeButtonIndex--
        : a.activeButtonIndex == a.numInteractiveElements(a) - 1
        ? a.audioService.playOopsSound()
        : a.activeButtonIndex++;
...
Blockly.CommonModal.getInteractiveElements = function (a) {
  return Array.prototype.filter.call(
    a.getInteractiveContainer().elements,
    function (a) {
    ...
    constructor: [
      ...
      function (a, b, c) {
        ...
        this.blockOptionsModalService.registerPreShowHook(function (a, b) {
          ...
          d.onDismissCallback = b;
          Blockly.CommonModal.setupKeyboardOverrides(d);
          d.keyboardInputService.addOverride("13", function (a) {
            a.preventDefault();
            a.stopPropagation();
            -1 != d.activeButtonIndex &&
              (document.getElementById(d.getOptionId(d.activeButtonIndex)),
              d.activeButtonIndex < d.actionButtonsInfo.length
                ? d.actionButtonsInfo[d.activeButtonIndex].action()
                : d.dismissModal(),
              d.hideModal());
          });
          setTimeout(function () {
...
blocklyApp.TreeService = ng.core.Class({
  ...
  scrollToElement_: function (a) {
    ...
    (a.offsetTop < b.scrollTop ||
      a.offsetTop > b.scrollTop + window.innerHeight) &&
      window.scrollTo(0, a.offsetTop - 10);
  },
  isLi_: function (a) {
    return "LI" == a.tagName;
  },
  ...
  getPreviousSiblingLi_: function (a) {
    if (a.previousElementSibling)
      return (
        ...
        this.isLi_(a) ? a : this.getLastChildLi_(a)
      );
  ...
  getNextSiblingLi_: function (a) {
    if (a.nextElementSibling)
      return (
        (a = a.nextElementSibling), this.isLi_(a) ? a : this.getFirstChildLi_(a)
      );
    for (a = a.parentNode; a && "OL" != a.tagName; ) {
      if (a.nextElementSibling)
        return (
          (a = a.nextElementSibling),
          this.isLi_(a) ? a : this.getFirstChildLi_(a)
        );
      a = a.parentNode;
    }
    return null;
  ...
  isIsolatedTopLevelBlock_: function (a) {
    var b =
      (!a.nextConnection || !a.nextConnection.targetConnection) &&
      (!a.previousConnection || !a.previousConnection.targetConnection);
    ...
    if (c ? this.isTopLevelBlock_(a) : this.isIsolatedTopLevelBlock_(a)) {
      ...
      setTimeout(function () {
        e
          ? e.focus()
          : document
              .getElementById(blocklyApp.ID_FOR_EMPTY_WORKSPACE_BTN)
              .focus();
      });
    } else {
      ...
      a = document.getElementById(a);
      var f = c
        ? this.getParentLi_(a) || this.getPreviousSiblingLi_(a)
        : this.getParentLi_(a) ||
          this.getNextSiblingLi_(a) ||
          this.getPreviousSiblingLi_(a);
      this.clearActiveDesc(d);
      b();
      var g = this;
      setTimeout(function () {
        g.setActiveDesc(f.id, d);
  ...
  getTreeIdForBlock: function (a) {
    for (
      a = document.getElementById(this.getBlockRootId_(a));
      !this.isTreeRoot_(a);
  ...
  showBlockOptionsModal: function (a) {
    ...
    this.blockConnectionService.canBeMovedToMarkedConnection(a) &&
      c.push({
        action: function () {
          var c = b.utilsService.getBlockDescription(a),
            e = b.getTreeIdForBlock(
              b.blockConnectionService.getMarkedConnectionSourceBlock().id
            );
          b.clearActiveDesc(e);
          var f = b.blockConnectionService.attachToMarkedConnection(a);
          b.safelyRemoveBlock_(
            a,
            function () {
              a.dispose(!1);
            },
          ...
          setTimeout(function () {
            ...
            if (b.getTreeIdForBlock(f) != e && document.getElementById(e)) {
              ...
              a &&
                ((a = b.getContainingBlock_(document.getElementById(a))),
                (a = b.getTreeIdForBlock(a)),
                a != e && b.clearActiveDesc(e));
              b.initActiveDesc(e);
            }
            b.notificationsService.speak(
              c +
                " " +
      ...
      action: function () {
        ...
        setTimeout(function () {
          var a =
            c +
            " deleted. " +
            (b.utilsService.isWorkspaceEmpty()
              ? "Workspace is empty."
              : "Now on workspace.");
          b.notificationsService.speak(a);
        });
  ...
  moveUpOneLevel_: function (a) {
    var b = document.getElementById(this.getActiveDescId(a));
    (b = this.getParentLi_(b))
      ? this.setActiveDesc(b.id, a)
  ...
  onKeypress: function (a, b) {
    if (
      ...
      c ||
        (this.initActiveDesc(b),
        (c = document.getElementById(this.getActiveDescId(b))));
      if (!a.altKey && !a.ctrlKey)
        if (
          ...
          a ||
            ((a = this.getContainingBlock_(c)), this.showBlockOptionsModal(a));
        } else if (
          9 != a.keyCode &&
          -1 !== [27, 35, 36, 37, 38, 39, 40].indexOf(a.keyCode)
        ) {
          if (27 == a.keyCode || 37 == a.keyCode) this.moveUpOneLevel_(b);
          else if (35 == a.keyCode)
            (c = this.getFinalSiblingLi_(c)) && this.setActiveDesc(c.id, b);
          else if (36 == a.keyCode)
            (c = this.getInitialSiblingLi_(c)) && this.setActiveDesc(c.id, b);
          else if (38 == a.keyCode) {
            var e = this.getPreviousSiblingLi_(c);
            e
              ? this.setActiveDesc(e.id, b)
              : ((b = "Reached top of list."),
                this.getParentLi_(c) &&
                  (b += " Press left to go to parent list."),
                this.audioService.playOopsSound(b));
          } else
            39 == a.keyCode
              ? (c = this.getFirstChildLi_(c))
                ? this.setActiveDesc(c.id, b)
                : this.audioService.playOopsSound()
              : 40 == a.keyCode &&
                ((c = this.getNextSiblingLi_(c))
                  ? this.setActiveDesc(c.id, b)
...
blocklyApp.ToolboxModalService = ng.core.Class({
  constructor: [
    ...
    function (a, b, c, d) {
      ...
      this.preShowHook = function () {
        throw Error(
          "A pre-show hook must be defined for the toolbox modal before it can be shown."
        );
      };
    },
  ],
  populateToolbox_: function () {
    ...
    if (b.length)
      this.allToolboxCategories = Array.from(b).map(function (a) {
        var b = new Blockly.Workspace(),
          c = a.attributes.custom;
        c && c.value == Blockly.VARIABLE_CATEGORY_NAME
          ? Blockly.Variables.flyoutCategoryBlocks(
              blocklyApp.workspace
            ).forEach(function (a) {
  ...
  computeCategoriesForCreateNewGroupModal_: function () {
    ...
    this.allToolboxCategories.forEach(function (b) {
      ...
      0 < c.length &&
        a.toolboxCategoriesForNewGroup.push({
  ...
  registerPreShowHook: function (a) {
    ...
    this.preShowHook = function () {
      a(
        b.selectedToolboxCategories,
        b.onSelectBlockCallback,
        b.onDismissCallback
      );
    };
  },
  ...
  toolboxHasVariableCategory: function () {
    if (null === this.hasVariableCategory) {
      var a = document
          .getElementById("blockly-toolbox-xml")
          .getElementsByTagName("category"),
        b = this;
      Array.from(a).forEach(function (a) {
        (a = a.attributes.custom) &&
          a.value == Blockly.VARIABLE_CATEGORY_NAME &&
          (b.hasVariableCategory = !0);
      });
  ...
  showToolboxModalForAttachToMarkedConnection: function (a) {
    ...
    this.showModal_(
      ...
      function (a) {
        var c = b.utilsService.getBlockDescription(a),
          d = b.treeService.getTreeIdForBlock(
            b.blockConnectionService.getMarkedConnectionSourceBlock().id
          );
        ...
        setTimeout(function () {
          ...
          b.notificationsService.speak(
            "Attached. Now on, " + c + ", block in workspace."
          );
        });
      },
      function () {
    ...
    this.showModal_(
      ...
      function (a) {
        ...
        setTimeout(function () {
          ...
          b.notificationsService.speak(
            "Created new group in workspace. Now on, " +
              c +
              ", block in workspace."
          );
        });
...
blocklyApp.ToolboxModalComponent = ng.core
  .Component({
            ...
            if (-1 != f.activeButtonIndex) {
              ...
              for (a = 0; a < f.toolboxCategories.length; a++)
                if (f.firstBlockIndexes[a + 1] > f.activeButtonIndex) {
                  a = f.getBlock(
                    a,
                    f.activeButtonIndex - f.firstBlockIndexes[a]
                  );
                  f.selectBlock(a);
                  return;
                }
...
blocklyApp.VariableAddModalComponent = ng.core
  .Component({
...
blocklyApp.VariableRemoveModalComponent = ng.core
  ...
  .Class({
    ...
    getNumVariables: function () {
      return this.variableModalService.getNumVariables(
        this.currentVariableName
      );
    },
    submit: function () {
  ...
  .Class({
    ...
    ngDoCheck: function () {
      if (this.isDropdown() && this.shouldBreakCache()) {
        ...
        for (var a = 0; a < this.dropdownOptions.length; a++)
          this.dropdownOptions[a].text === this.fieldValue &&
            (this.selectedOption = this.dropdownOptions[a].value);
      }
    },
    shouldBreakCache: function () {
      ...
      return this.fieldValue != this.mainField.getValue() ? !0 : !1;
    },
    ...
    isTextInput: function () {
      return (
        this.mainField instanceof Blockly.FieldTextInput &&
    ...
    selectOption: function () {
      this.optionValue != Blockly.RENAME_VARIABLE_ID &&
        this.optionValue != Blockly.DELETE_VARIABLE_ID &&
...
blocklyApp.WorkspaceBlockComponent = ng.core
  ...
  .Class({
    ...
    ngDoCheck: function () {
      if (this.cachedBlockId != this.block.id) {
        ...
        this.componentIds.inputs = this.block.inputList.map(function (a, d) {
          ...
          a.connection &&
            !a.connection.targetBlock() &&
            c.push("actionButtonLi", "actionButton", "buttonLabel");
          var f = {};
    ...
    ngAfterViewInit: function () {
      ...
      setTimeout(function () {
        0 !== a.level ||
          a.treeService.getActiveDescId(a.tree.id) ||
          a.treeService.setActiveDesc(a.componentIds.blockRoot, a.tree.id);
      });
    },
