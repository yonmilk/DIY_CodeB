...
Blockly.Python['logic_isinstance'] = function(block) {
  var value_instance = Blockly.Python.valueToCode(block, 'INSTANCE', Blockly.Python.ORDER_ATOMIC);
  var value_type = Blockly.Python.valueToCode(block, 'TYPE', Blockly.Python.ORDER_ATOMIC);
  var code ="isinstance("+value_instance+","+value_type+")";
  return [code, Blockly.Python.ORDER_ATOMIC];
};
